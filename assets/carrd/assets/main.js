...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#icons03', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('.buttons.style1', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#image06', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#image01', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('h1.style17, h2.style17, h3.style17, p.style17', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#text02', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('.icons.style1', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#text30', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('.buttons.style2', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#text31', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#text32', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#form01', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('h1.style18, h2.style18, h3.style18, p.style18', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('h1.style7, h2.style7, h3.style7, p.style7', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('h1.style6, h2.style6, h3.style6, p.style6', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#text07', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('h1.style8, h2.style8, h3.style8, p.style8', { style: 'blur-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#text05', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#text33', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('.image.style1', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('h1.style11, h2.style11, h3.style11, p.style11', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('h1.style12, h2.style12, h3.style12, p.style12', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('.table-wrapper.style1', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('h1.style14, h2.style14, h3.style14, p.style14', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('h1.style13, h2.style13, h3.style13, p.style13', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#icons04', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#buttons01', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('h1.style5, h2.style5, h3.style5, p.style5', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#buttons05', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#text10', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#text12', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#icons01', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
